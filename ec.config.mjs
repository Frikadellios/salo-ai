...
export default defineEcConfig({
  styleOverrides: {
    ...
    frames: {
      ...
      editorTabBarBackground: 'var(--color-background)',
      frameBoxShadowCssValue: 'var(--color-lime)',
      inlineButtonBackground: 'var(--color-cheiter)',
      inlineButtonBorder: 'var(--color-foreground)',
      terminalTitlebarBackground: 'var(--color-background)',
    },
    textMarkers: {
